...
class DrugInfo(BaseModel):
    ...
    permit_date: Optional[str] = Field(None, description="허가일자(단축)")
    permit_no: Optional[str] = Field(None, description="허가번호")
    ...
    etc_otc_code: Optional[str] = Field(None, description="전문/일반 구분 코드")
    chart: Optional[str] = Field(None, description="성상")
    material_name: Optional[str] = Field(None, description="원료성분")
    storage_method: Optional[str] = Field(None, description="저장방법")
    valid_term: Optional[str] = Field(None, description="유효기간")
    pack_unit: Optional[str] = Field(None, description="포장단위")
    raw_json: Optional[str] = Field(None, description="원본 JSON 문자열")
